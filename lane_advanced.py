...
def draw_lane_lines(lane_lines, img, shade_background=False):
    ...
    return weighted_img(lane_line_image, img, a=a, b=1.)
...
def draw_dashboard(img, snapshot1, snapshot2):
    ...
    img = weighted_img(image_copy, img, a=0.3, b=0.7)
...
os.chdir('/home/mukesh-deo/Documents/carnd-master/p1_lane_lines_detection/')
...
while True:
    ...
    cv2.imshow('edge',image_pipeline(image))
